            ...
            success: function (data) {
                $.each(data, function (index, first) {
                    ...
                    $.each(first.menus, function (index1, second) {
                        a += "<p style='text-align: center'><a id=\"btn\" href=\"#\" class=\"easyui-linkbutton\" onclick=\"addTabs('" + second.title + "','" + second.iconcls + "','" + second.url + "')\" data-options=\"iconCls:'icon-cut'\">" + second.title + "</a></p>";
                    })
                    $('#aa').accordion('add', {
                        title: first.title,
